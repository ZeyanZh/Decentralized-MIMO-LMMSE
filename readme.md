...
Note that the spatial correlation matrices $\{\mathbf{R}_j\}_{j \leq n}$ are given. Please rewrite the function `SINRAna.init_correlations` to set up your own correlation matrices.